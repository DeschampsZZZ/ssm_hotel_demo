...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="all-admin-index.html" class="logo">
            ...
            <span class="logo-mini"><b>HOTEL</b></span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>HOTEL</b>管理系统</span>
        </a>
        ...
        <section class="content">
            <div class="error-page">
                ...
                <div class="error-content">
                    <h3><i class="fa fa-warning text-red"></i> 对不起! 你的权限不足.</h3>

                    <p>
                        你访问的页面禁止访问, 你可以 <a href="${pageContext.request.contextPath}/pages/main.jsp">返回到后台首页</a> 或者通过搜索查询
                    </p>
