...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <form action="${pageContext.request.contextPath}/orders/addOrder.do"
                  method="post">
                <!-- 正文区域 -->
                <section class="content"> <!--订单信息-->

                    <input type="hidden" value="${room.roomId}" name="roomId" >
                    <input type="hidden" value="${room.roomPrice}" name="orderPrice" >
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="row data-type">
                            ...
                            <div class="col-md-2 title">顾客</div>
                            <div class="col-md-4 data">
                                <input type="text" class="form-control" name="customer"
                                       placeholder="顾客" value="" >
                            </div>
                            ...
                            <div class="col-md-4 data">
                                <input type="text" class="form-control" placeholder="房间号"
                                       name="roomNumber" value="${room.roomNumber }" readonly="readonly">
                            </div>

                            <div class="col-md-2 title">房间类型</div>
                            <div class="col-md-4 data">
                                <input type="text" class="form-control" placeholder="房间类型"
                                       name="roomType" value="${room.roomType }" readonly="readonly">
                            </div>

                            <div class="col-md-2 title">价格</div>
                            <div class="col-md-4 data">
                                <input type="text" class="form-control" placeholder="订单价格"
                                       name="orderPrice" value="¥${room.roomPrice}" readonly="readonly">
                            </div>
                    </div>
                    <!--订单信息/-->
